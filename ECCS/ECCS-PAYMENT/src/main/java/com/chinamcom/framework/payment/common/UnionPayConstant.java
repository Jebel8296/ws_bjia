package com.chinamcom.framework.payment.common;
...
import com.chinamcom.framework.payment.sdk.union.SDKConfig;
import com.chinamcom.framework.payment.sdk.union.SDKConstants;

public class UnionPayConstant {

	//商户编码
	public static String merId = "777290058110097";//777290058110048   777290058110097
	//默认配置的是UTF-8
	...
	public static String frontUrl = "http://127.0.0.1:60060/frontUnionRcvResp.do";

	//后台服务对应的写法参照 BackRcvResponse.java
	public static String backUrl = "http://127.0.0.1:60060/backUnionRcvResp.do";//受理方和发卡方自选填写的域[O]--后台通知地址
