var zhongmai = angular.module('myApp', ["ngStorage", "ngCookies", "ui.router", 'LocalStorageModule', 'ui.bootstrap', 'angular-md5']);
zhongmai.factory("httpInterceptor", function ($q, $cookieStore) {
    var httpInterceptor = {
...
zhongmai.factory("ZMHTTP", function ($http, $q, md5) {
    var service = {
        post: function (method, data) {
            var siginMd5 = md5.createHash(JSON.stringify(data));
            var config = {
                service: method,
    ...
    function handleRequest(data) {
        var defer = $q.defer();
        var promise = $http.post(posturl, data);
        promise.then(function (response) {
            if (response.status == 200) {
                if (response.data.code == 200 || response.data.code == 509) {
...
zhongmai.factory('UrlService', function (ZMHTTP, $cookieStore) {
    var url = {
        ORDER: {
            search: function (data) {
                return ZMHTTP.post("zm3c.order.list", data).then(function (res) { return res; });
            },
            cannel: function (data) {
                return ZMHTTP.post("zm3c.order.cancel", data).then(function (res) { return res; });
            },
            close: function (data) {
                return ZMHTTP.post("zm3c.order.close", data).then(function (res) { return res; });
            },
            receipt: function (data) {
                return ZMHTTP.post("zm3c.order.receipt", data).then(function (res) { return res; });
            },
            info: function (data) {
                return ZMHTTP.post("zm3c.order.info", data).then(function (res) { return res; });
            },
            add: function (data) {
                return ZMHTTP.post("zm3c.order.add", data).then(function (res) { return res; });
            }
        },
        CART: {
            add: function (data) {
                return ZMHTTP.post("zm3c.cart.add", data).then(function (res) { return res; });
            },
            list: function (data) {
                return ZMHTTP.post("zm3c.cart.list", data).then(function (res) { return res; });
            },
            account: function (data) {
                return ZMHTTP.post("zm3c.cart.account", data).then(function (res) { return res; });
            }
        },
        PAY: {
            jumppay: function (data) {
                return ZMHTTP.post("zm3c.payment.jumppay", data).then(function (res) { return res; });
            }
        },
        AFTERSALE: {
            search: function (data) {
                return ZMHTTP.post("zm3c.aftersale.list", data).then(function (res) { return res; });
            },
            cancel: function (data) {
                return ZMHTTP.post("zm3c.aftersale.cancel", data).then(function (res) { return res; });
            },
            info: function (data) {
                return ZMHTTP.post("zm3c.aftersale.info", data).then(function (res) { return res; });
            },
            upload: function (data) {
                return ZMHTTP.post("zm3c.aftersale.upload", data).then(function (res) { return res; });
            },
            apply: function (data) {
                return ZMHTTP.post("zm3c.aftersale.apply", data).then(function (res) { return res; });
            },
            second: function (data) {
                return ZMHTTP.post("zm3c.aftersale.second", data).then(function (res) { return res; });
            },
            device: function (data) {
                return ZMHTTP.post("zm3c.aftersale.device", data).then(function (res) { return res; });
            }
        },
        USER: {
            //...
        ...
        PRODUCT: {
            get: function (data) {
                return ZMHTTP.post("zm3c.product.query", data).then(function (res) { return res; });
            },
        },
        CODE: {
            generate: function (data) {
                return ZMHTTP.post("zm3c.generate.code", data).then(function (res) { return res; });
            }
        },
        EXPRESS: {
            add: function (data) {
                return ZMHTTP.post("zm3c.express.add", data).then(function (res) { return res; });
            },
            get: function (data) {
                return ZMHTTP.post("zm3c.express.list", data).then(function (res) { return res; });
            },
            def: function (data) {
                return ZMHTTP.post("zm3c.express.def", data).then(function (res) { return res; });
            },
            del: function (data) {
                return ZMHTTP.post("zm3c.express.del", data).then(function (res) { return res; });
            },
            mod: function (data) {
                return ZMHTTP.post("zm3c.express.mod", data).then(function (res) { return res; });
            },
            address: function () {
                var division = {
...
zhongmai.config(['$stateProvider', '$urlRouterProvider', '$httpProvider', '$locationProvider', 'localStorageServiceProvider',
    function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, localStorageServiceProvider, $rootScope, $cookieStore) {
        ...
        $stateProvider
            .state('home', {
                title: '青少年3C产品',
                url: '/',
                templateUrl: 'templete/product.html'
            })
            .state('download', {
                title: '下载页面',
                url: '/download',
                cache: 'false',
                templateUrl: 'templete/download.html'
            })
            .state('headsets', {
                title: '必加智能耳机',
                url: '/headsets',
                cache: 'false',
                templateUrl: 'templete/productHeadsetList.html'
            })
            .state('watches', {
                title: '必加电话手表',
                url: '/watches',
                cache: 'false',
                templateUrl: 'templete/productWatchList.html'
            })
            .state('watche', {
                title: '手表',
                url: '/watche/:prodcode',
                cache: 'false',
                templateUrl: 'templete/watches.html'
            })
            .state('model', {
                title: ' 必加产品',
                url: '/model',
                cache: 'false',
                templateUrl: 'templete/model.html'
            })
            .state('headset', {
                title: '耳机',
                url: '/watche/:prodcode',
            ...
            .state('monitorlist', {
                ...
                url: '/monitor',
                cache: 'false',
                templateUrl: 'templete/monitor/monitor.html'
            })
            .state('handlelist', {
                title: '售后受理',
                url: '/handle',
            ...
            .state('mycart', {
                ...
                url: '/mycart',
                cache: 'false',
                templateUrl: 'templete/myshopcart.html'
            })
            .state('orderlist', {
                title: '我的订单',
                url: '/orderlist',
                cache: 'false',
                templateUrl: 'templete/orderlist.html',
            ...
            .state('address', {
                ...
                url: '/address',
                cache: 'false',
                templateUrl: 'templete/address/address.html'
            })
            .state('changepwd', {
                title: '修改密码',
                url: '/changepwd',
            ...
            .state('changepwdd', {
                ...
                url: '/changepwdd',
                cache: 'false',
                templateUrl: 'templete/password/changePSD.html'
            })
            .state('comfirm', {
                title: '提交订单',
                url: '/comfirm/:comfirmId/',
                cache: 'false',
                templateUrl: 'templete/confirmpage.html'
            })
            .state('comfirmby', {
                title: '提交订单',
                url: '/comfirm/:comfirmId/:comfirmTotal',
                cache: 'false',
                templateUrl: 'templete/confirmpageByid.html'
            })
            .state('paysuccess', {
                title: '支付页面',
                url: '/paysuccess/:ordercode',
                cache: 'false',
                templateUrl: 'templete/common/paysuccess.html'
            })
            .state('commonP', {
                title: '支付页面',
                url: '/commonP/:uid/:cid/:payT',
                cache: 'false',
                templateUrl: 'templete/common/commonconfirm.html'
            })
            .state('commonPt', {
                title: '支付页面',
                url: '/commonP/:aftercode',
                cache: 'false',
                templateUrl: 'templete/common/commonconfirm.html'
            })
            .state('pay', {
                ...
                url: '/pay',
                cache: 'false',
                templateUrl: 'templete/pay.html'

            })
            .state('servicereq', {
                title: '申请售后',
                url: '/servicereq/:orderId/:servId',
                cache: 'false',
                templateUrl: 'templete/servicerequest.html'
            })
            .state('servicereqbyid', {
                title: '申请售后',
                url: '/servicereqbyid/:decives/:cdate',
                cache: 'false',
                templateUrl: 'templete/servicerequestbyid.html'
            })
            .state('orderdetail', {
                title: '订单详情',
            ...
            .state('servicedetail', {
                title: '售后详情',
                url: '/servicedetail/:afterid',
                cache: 'false',
                templateUrl: "templete/servicedetail.html"
            })
            .state('secondservice', {
                title: '再次申请售后',
                url: '/secondservice/:afterid',
                cache: 'false',
                templateUrl: "templete/secondservice.html"
            })
            .state('servicelist', {
                title: '我的售后',
                url: '/servicelist',
                cache: 'false',
                templateUrl: 'templete/servicelist.html'
            })
            .state('orderpay', {
                title: '申请售后',
                url: '/orderpay',
                cache: 'false',
                templateUrl: 'templete/orderpay.html'
            })
            ...
            .state('ad', {
                ...
                url: '/ad',
                cache: 'false',
                templateUrl: 'templete/tempforad/test.html'
            })
    }
]);
